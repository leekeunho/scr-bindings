...
begin
  ...
  case ListFrame.ItemByIndex(ListFrame.ItemIndex).Tag of
    MFRONT:
      Rectangle.Material.Diffuse := ColorPanelFrame.Color;
    MLEFT:
      Rectangle.MaterialShaft.Diffuse := ColorPanelFrame.Color;
    MBACK:
      Rectangle.MaterialBack.Diffuse := ColorPanelFrame.Color;
  end;
...
begin
  case ListText.ItemByIndex(ListText.ItemIndex).Tag of
    MFRONT:
      Text3D.Material.Diffuse := ColorPanelText.Color;
    MLEFT:
      Text3D.MaterialShaft.Diffuse := ColorPanelText.Color;
    MBACK:
      Text3D.MaterialBack.Diffuse := ColorPanelText.Color;
  end;
...
begin
  ...
  begin
    ...
    case List.ItemByIndex(List.ItemIndex).Tag of
      MFRONT:
        Obj.Material.Texture.LoadFromFile(FileName);
      MLEFT:
        Obj.MaterialShaft.Texture.LoadFromFile(FileName);
      MBACK:
        Obj.MaterialBack.Texture.LoadFromFile(FileName);
    end;
...
begin
  ...
  ImageType := DefaultBitmapCodecClass.GetFileTypes;
...
begin
  ...
  case ListFrame.ItemByIndex(ListFrame.ItemIndex).Tag of
    MFRONT:
      begin
        ColorPanelFrame.Color := Rectangle.Material.Diffuse;
        FrameTexture.Bitmap := Rectangle.Material.Texture;
      end;
    MLEFT:
      begin
        ColorPanelFrame.Color := Rectangle.MaterialShaft.Diffuse;
        FrameTexture.Bitmap := Rectangle.MaterialShaft.Texture;
      end;
    MBACK:
      begin
        ColorPanelFrame.Color := Rectangle.MaterialBack.Diffuse;
        FrameTexture.Bitmap := Rectangle.MaterialBack.Texture;
      end;
  end;
...
begin
  case ListText.ItemByIndex(ListText.ItemIndex).Tag of
    MFRONT:
      begin
        ColorPanelText.Color := Text3D.Material.Diffuse;
        TextTexture.Bitmap := Text3D.Material.Texture;
      end;
    MLEFT:
      begin
        ColorPanelText.Color := Text3D.MaterialShaft.Diffuse;
        TextTexture.Bitmap := Text3D.MaterialShaft.Texture;
      end;
    MBACK:
      begin
        ColorPanelText.Color := Text3D.MaterialBack.Diffuse;
        TextTexture.Bitmap := Text3D.MaterialShaft.Texture;
      end;
  end;
...
begin
  ...
  Rectangle.Material.Texture.SetSize(0, 0);
  Rectangle.MaterialShaft.Texture.SetSize(0, 0);
  Rectangle.MaterialBack.Texture.SetSize(0, 0);

  Rectangle.Material.Diffuse := TAlphaColorRec.Null;
  Rectangle.MaterialShaft.Diffuse := TAlphaColorRec.White;
  Rectangle.MaterialBack.Diffuse := TAlphaColorRec.White;

  Text3D.Material.Texture.SetSize(0, 0);
  Text3D.MaterialShaft.Texture.SetSize(0, 0);
  Text3D.MaterialBack.Texture.SetSize(0, 0);

  Text3D.Material.Diffuse := TAlphaColorRec.White;
  Text3D.MaterialShaft.Diffuse := TAlphaColorRec.Darkgray;
  Text3D.MaterialBack.Diffuse := TAlphaColorRec.White;
...
begin
  ...
  begin
    case List.ItemByIndex(List.ItemIndex).Tag of
      MFRONT:
        Obj.Material.Texture.SetSize(0, 0);
      MLEFT:
        Obj.MaterialShaft.Texture.SetSize(0, 0);
      MBACK:
        Obj.MaterialBack.Texture.SetSize(0, 0);
    end;
...
begin
  if not isAnimationRunning then
  begin
    Camera.Position.Vector := Vector3DAdd(Camera.Position.Vector,
